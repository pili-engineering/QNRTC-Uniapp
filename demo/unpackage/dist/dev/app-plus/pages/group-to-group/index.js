...
try {
  components = {
    uniTag: __webpack_require__(/*! @/uni_modules/uni-tag/components/uni-tag/uni-tag.vue */ 351)
      .default,
    uniEasyinput:
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 16);\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\nvar _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 55));\nvar _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 62));\nvar _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 63));\nvar _RTCIndexNative = __webpack_require__(/*! @/js_sdk/QNRTC-UniPlugin-JS/QNRTC-UniPlugin-JS/RTCIndex.native.js */ 221);\nvar _vuex = __webpack_require__(/*! vuex */ 78);\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }\nvar _default = {\n  computed: _objectSpread({}, (0, _vuex.mapState)(['captureHeight', 'captureWidth', 'encodeWidth', 'encodeHeight', 'platform', 'multiStreamEnable', 'token', 'policy', 'logLevel', 'stereo', 'bwePolicy', 'allowAudioMixWithOthers', 'hWCodecEnabled', 'maintainResolution', 'fieldTrials', 'encoderQualityMode', 'isAEC3Enabled', 'multiStreamEnable', 'audioScene', 'defaultAudioRouteToSpeakerphone', 'reconnectionTimeout', 'clientRole', 'clientMode'])),\n  data: function data() {\n    return {\n      remoteTracks: [],\n      publishedTracks: [],\n      localVideoTrackStats: {},\n      localAudioTrackStats: {},\n      localTracks: [],\n      client: null,\n      connectionState: '',\n      message: '',\n      subscribedTracks: [],\n      remoteUsers: [],\n      remoteVideoTrackStats: [],\n      remoteAudioTrackStats: []\n    };\n  },\n  onBackPress: function onBackPress() {\n    this.client.leave();\n    _RTCIndexNative.QNRTC.deinit();\n    __f__(\"log\", '执行onUnload', \" at pages/group-to-group/index.nvue:367\");\n  },\n  onUnload: function onUnload() {\n    this.client.leave();\n    _RTCIndexNative.QNRTC.deinit();\n  },\n  onLoad: function onLoad() {\n    this.handleJoinRoom();\n    // setInterval(() => {\n    //   if (this.client) {\n    //     this.connectionState = this.client.getConnectionState()\n    //     this.remoteUsers = this.client.getRemoteUsers()\n    //     this.subscribedTracks = []\n    //     for (let i of this.remoteUsers) {\n    //       this.subscribedTracks.push(...this.client.getSubscribedTracks(i.userID))\n    //       const networkQuality = this.client.getUserNetworkQuality(i.userID)\n    //       this.$set(i, 'networkQuality', networkQuality)\n    //     }\n    //     this.remoteVideoTrackStats = this.client.getRemoteVideoTrackStats()\n    //     for (let i of this.remoteTracks) {\n    //       for (let key in this.remoteVideoTrackStats)\n    //         if (i.trackID === key) {\n    //           i.stats = this.remoteVideoTrackStats[key]\n    //         }\n    //     }\n    //     this.remoteAudioTrackStats = this.client.getRemoteAudioTrackStats()\n    //     for (let i of this.remoteTracks) {\n    //       for (let key in this.remoteAudioTrackStats)\n    //         if (i.trackID === key) {\n    //           i.stats = this.remoteAudioTrackStats[key]\n    //         }\n    //     }\n    //     this.publishedTracks = this.client.getPublishedTracks()\n    //     this.localAudioTrackStats = this.client.getLocalAudioTrackStats()\n    //     this.localVideoTrackStats = this.client.getLocalVideoTrackStats()\n    //   }\n    // }, 1000)\n  },\n\n  methods: {\n    saveBaseImgFile: function saveBaseImgFile(base64) {\n      var bitmap = new plus.nativeObj.Bitmap('base64');\n      bitmap.loadBase64Data(base64, function () {\n        var url = '_doc/' + new Date().getTime() + '.png';\n        __f__(\"log\", 'saveHeadImgFile', url, \" at pages/group-to-group/index.nvue:412\");\n        bitmap.save(url, {\n          overwrite: true // 是否覆盖\n          // quality: 'quality'  // 图片清晰度\n        }, function (i) {\n          uni.saveImageToPhotosAlbum({\n            filePath: url,\n            success: function success() {\n              uni.showToast({\n                title: '图片保存成功',\n                icon: 'none'\n              });\n              bitmap.clear();\n            }\n          });\n        }, function (e) {\n          uni.showToast({\n            title: '图片保存失败',\n            icon: 'none'\n          });\n          __f__(\"log\", e, \" at pages/group-to-group/index.nvue:436\");\n          bitmap.clear();\n        });\n      }, function (e) {\n        uni.showToast({\n          title: '图片保存失败',\n          icon: 'none'\n        });\n        bitmap.clear();\n      });\n    },\n    takeLocalVideoSnapshot: function takeLocalVideoSnapshot() {\n      var _this = this;\n      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {\n        var _yield$_this$cameraVi, base64, rotate;\n        return _regenerator.default.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.next = 2;\n                return _this.cameraVideoTrack.takeVideoSnapshot();\n              case 2:\n                _yield$_this$cameraVi = _context.sent;\n                base64 = _yield$_this$cameraVi.base64;\n                rotate = _yield$_this$cameraVi.rotate;\n                _this.saveBaseImgFile(base64);\n              case 6:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }))();\n    },\n    takeRemoteVideoSnapshot: function takeRemoteVideoSnapshot(item) {\n      var _this2 = this;\n      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {\n        var _yield$item$takeVideo, base64, rotate;\n        return _regenerator.default.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                _context2.next = 2;\n                return item.takeVideoSnapshot();\n              case 2:\n                _yield$item$takeVideo = _context2.sent;\n                base64 = _yield$item$takeVideo.base64;\n                rotate = _yield$item$takeVideo.rotate;\n                _this2.saveBaseImgFile(base64);\n              case 6:\n              case \"end\":\n                return _context2.stop();\n            }\n          }\n        }, _callee2);\n      }))();\n    },\n    handleSendMessage: function handleSendMessage() {\n      this.client.sendMessage(this.message, [], Math.random() + 'messageID');\n    },\n    handleJoinRoom: function handleJoinRoom() {\n      var _this3 = this;\n      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {\n        var cameraVideoTrack, microphoneAudioTrack, screenVideoTrack;\n        return _regenerator.default.wrap(function _callee3$(_context3) {\n          while (1) {\n            switch (_context3.prev = _context3.next) {\n              case 0:\n                if (!(_this3.connectionState === 'CONNECTED')) {\n                  _context3.next = 3;\n                  break;\n                }\n                uni.showModal({\n                  content: '已经加入房间'\n                });\n                return _context3.abrupt(\"return\", false);\n              case 3:\n                _RTCIndexNative.QNRTC.configRTC({\n                  policy: _this3.policy,\n                  logLevel: _this3.logLevel,\n                  stereo: _this3.stereo === 1,\n                  bwePolicy: _this3.bwePolicy,\n                  allowAudioMixWithOthers: _this3.allowAudioMixWithOthers === 1,\n                  hWCodecEnabled: _this3.hWCodecEnabled === 1,\n                  maintainResolution: _this3.maintainResolution === 1,\n                  fieldTrials: _this3.fieldTrials,\n                  encoderQualityMode: _this3.encoderQualityMode === 1,\n                  isAEC3Enabled: _this3.isAEC3Enabled === 1,\n                  audioScene: _this3.audioScene,\n                  defaultAudioRouteToSpeakerphone: _this3.defaultAudioRouteToSpeakerphone,\n                  reconnectionTimeout: _this3.reconnectionTimeout\n                });\n                _this3.client = _RTCIndexNative.QNRTC.createClient({\n                  mode: _this3.clientMode,\n                  role: _this3.clientRole\n                });\n                _this3.client.setAutoSubscribe(false);\n                cameraVideoTrack = _RTCIndexNative.QNRTC.createCameraVideoTrack({\n                  multiStreamEnable: _this3.multiStreamEnable === 1,\n                  width: _this3.encodeWidth * 1,\n                  height: _this3.encodeHeight * 1,\n                  captureHeight: _this3.captureHeight * 1,\n                  captureWidth: _this3.captureWidth * 1\n                });\n                _this3.localTracks.push(cameraVideoTrack);\n                _this3.cameraVideoTrack = cameraVideoTrack;\n                microphoneAudioTrack = _RTCIndexNative.QNRTC.createMicrophoneAudioTrack();\n                _this3.localTracks.push(microphoneAudioTrack);\n                if (_RTCIndexNative.QNRTC.isScreenCaptureSupported()) {\n                  if (_this3.platform === 'android') {\n                    _RTCIndexNative.QNRTC.requestPermission(function (result) {\n                      if (result) {\n                        var screenVideoTrack = _RTCIndexNative.QNRTC.createScreenVideoTrack();\n                        _this3.localTracks.push(screenVideoTrack);\n                        _this3.client.join(_this3.token);\n                      } else {\n                        uni.showModal({\n                          content: '无法录屏'\n                        });\n                        _this3.client.join(_this3.token);\n                      }\n                    });\n                  } else {\n                    screenVideoTrack = _RTCIndexNative.QNRTC.createScreenVideoTrack();\n                    _this3.localTracks.push(screenVideoTrack);\n                    _this3.client.join(_this3.token);\n                  }\n                } else {\n                  _this3.client.join(_this3.token);\n                }\n                _this3.client.on('onConnectionStateChanged', function (_ref) {\n                  var state = _ref.state,\n                    info = _ref.info;\n                  if (state === 'CONNECTED') {\n                    _this3.client.publish(_this3.localTracks, function (onPublished, error) {\n                      if (onPublished) {\n                        uni.showModal({\n                          content: '发布成功'\n                        });\n                      } else {\n                        uni.showModal({\n                          content: error.message\n                        });\n                      }\n                    });\n                  } else if (state === 'DISCONNECTED') {\n                    if (info.reason === 'KICKED_OUT') {\n                      uni.showModal({\n                        content: '被踢出房间',\n                        success: function success(res) {\n                          uni.navigateBack();\n                        }\n                      });\n                    } else if (info.reason === 'ROOM_CLOSED') {\n                      uni.showModal({\n                        content: '房间被关闭',\n                        success: function success(res) {\n                          uni.navigateBack();\n                        }\n                      });\n                    } else if (info.reason === 'ROOM_FULL') {\n                      uni.showModal({\n                        content: '房间人数已满',\n                        success: function success(res) {\n                          uni.navigateBack();\n                        }\n                      });\n                    }\n                  } else if (state === 'RECONNECTING') {\n                    uni.showLoading({\n                      mask: true,\n                      title: '重连中'\n                    });\n                  } else if (state === 'RECONNECTED') {\n                    uni.hideLoading();\n                    uni.showModal({\n                      content: '重连成功'\n                    });\n                  }\n                });\n                _this3.client.on('onAudioSubscribed', function (params) {\n                  __f__(\"log\", '用户订阅成功', \" at pages/group-to-group/index.nvue:570\");\n                  var _iterator = _createForOfIteratorHelper(params.trackList),\n                    _step;\n                  try {\n                    for (_iterator.s(); !(_step = _iterator.n()).done;) {\n                      var i = _step.value;\n                      _this3.remoteTracks.push(i);\n                    }\n                  } catch (err) {\n                    _iterator.e(err);\n                  } finally {\n                    _iterator.f();\n                  }\n                });\n                _this3.client.on('onVideoSubscribed', function (params) {\n                  __f__(\"log\", '用户订阅成功', \" at pages/group-to-group/index.nvue:576\");\n                  var _iterator2 = _createForOfIteratorHelper(params.trackList),\n                    _step2;\n                  try {\n                    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {\n                      var i = _step2.value;\n                      _this3.remoteTracks.push(i);\n                    }\n                  } catch (err) {\n                    _iterator2.e(err);\n                  } finally {\n                    _iterator2.f();\n                  }\n                });\n                _this3.client.on('onUserPublished', function (params) {\n                  __f__(\"log\", '用户发布', params, \" at pages/group-to-group/index.nvue:582\");\n                  _this3.client.subscribe(params.trackList);\n                });\n                _this3.client.on('onUserUnpublished', function (params) {\n                  __f__(\"log\", '用户取消发布', params, \" at pages/group-to-group/index.nvue:586\");\n                  var _iterator3 = _createForOfIteratorHelper(params.trackList),\n                    _step3;\n                  try {\n                    var _loop = function _loop() {\n                      var i = _step3.value;\n                      var index = _this3.remoteTracks.findIndex(function (item) {\n                        return item.trackID === i.trackID;\n                      });\n                      if (index >= 0) {\n                        _this3.remoteTracks.splice(index, 1);\n                      }\n                    };\n                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {\n                      _loop();\n                    }\n                  } catch (err) {\n                    _iterator3.e(err);\n                  } finally {\n                    _iterator3.f();\n                  }\n                });\n                _this3.client.on('onMessageReceived', function (params) {\n                  __f__(\"log\", '接收到消息', params, \" at pages/group-to-group/index.nvue:595\");\n                  uni.showModal({\n                    content: \"\".concat(params.userId, \"\\u8BF4\\uFF1A\").concat(params.content)\n                  });\n                });\n                _this3.client.on('onUserReconnecting', function (params) {\n                  __f__(\"log\", '用户重连中', params, \" at pages/group-to-group/index.nvue:601\");\n                });\n                _this3.client.on('onUserReconnected', function (params) {\n                  __f__(\"log\", '用户重连成功', params, \" at pages/group-to-group/index.nvue:604\");\n                });\n                _this3.client.on('onUserLeft', function (params) {\n                  __f__(\"log\", '用户离开房间', params, \" at pages/group-to-group/index.nvue:607\");\n                });\n              case 21:\n              case \"end\":\n                return _context3.stop();\n            }\n          }\n        }, _callee3);\n      }))();\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 93)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///359\n");
