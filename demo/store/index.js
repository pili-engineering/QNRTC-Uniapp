...
const PREFIX = '/v1/rtc'
const API = {
  LIST_USERS: (appid, roomid) => `${HOST}${PREFIX}/users/app/${appid}/room/${roomid}`,
  GET_APP_CONFIG: (appid) => `${HOST}${PREFIX}/app/${appid}`,
